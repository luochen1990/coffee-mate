...
var Y, accumulate, all, any, array, best, bool, cart, chr, church, cube, dict, extend, float, hex, int, iterator, json, log, max, max_index, memorize, min, min_index, obj, ord, random_gen, ranged_random_gen, reversed, size, sleep, square, str, sum, url_encode, zip,
  __slice = [].slice;
