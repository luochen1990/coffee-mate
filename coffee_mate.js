...
var Y, accumulate, all, any, best, cart, chr, church, cube, dict, extend, float, hex, int, json, log, max, max_index, memorize, min, min_index, obj, ord, random_gen, ranged_random_gen, reversed, size, sleep, square, str, sum, url_encode, zip,
  __slice = [].slice;
...
extend = function(base, defaults) {
  var k, r, v;
  r = defaults != null ? dict((function() {
    var _results;
    _results = [];
    for (k in defaults) {
      v = defaults[k];
