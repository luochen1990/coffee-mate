...
var Y, accumulate, all, any, best, bool, cart, chr, church, cube, dict, extend, float, head, hex, int, iterator, json, list, log, max, max_index, memorize, min, min_index, obj, ord, random_gen, ranged_random_gen, reversed, size, sleep, square, str, sum, url_decode, url_encode, zip,
  __slice = [].slice;
